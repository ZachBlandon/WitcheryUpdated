...
public class BlockLeavesRowan extends BlockLeaves implements IHasModel { //see BlockLeavesAlder
	
    public BlockLeavesRowan(String name) {
    ...
    protected void dropApple(World worldIn, BlockPos pos, IBlockState state, int chance) {
        if (worldIn.rand.nextInt(chance) == 0) {
            ...
            worldIn.spawnEntity(new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModItems.ROWAN_BERRIES, 1)));
        }
    }
