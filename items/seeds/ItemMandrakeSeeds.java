...
public class ItemMandrakeSeeds extends ItemBase implements IHasModel, IPlantable { //see ItemBelladonnaSeeds

	public ItemMandrakeSeeds(String name) {
		super(name);
	}
										...
										EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		{
			worldIn.setBlockState(pos.up(), ModBlocks.MANDRAKE_PLANT.getDefaultState());
			stack.shrink(1);
	...
	public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
		return ModBlocks.MANDRAKE_PLANT.getDefaultState();
	}
}
