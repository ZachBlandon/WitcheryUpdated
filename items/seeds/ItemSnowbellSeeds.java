...
public class ItemSnowbellSeeds extends ItemBase implements IHasModel, IPlantable { //see ItemBelladonnaSeeds

	public ItemSnowbellSeeds(String name) {
		super(name);
	}
										...
										EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		{
			worldIn.setBlockState(pos.up(), ModBlocks.SNOWBELL_PLANT.getDefaultState());
			stack.shrink(1);
	...
	public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
		return ModBlocks.SNOWBELL_PLANT.getDefaultState();
	}
}